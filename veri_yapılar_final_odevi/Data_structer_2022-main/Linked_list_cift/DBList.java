public class DBList {//Bu satır, sınıfın tanımlanmasını sağlar. Sınıf adı "DBList" olarak belirlenmiştir.
    Nod head;/*
    Bu satır, sınıf içinde "head" adlı bir Nod tipinde bir değişken tanımlar. Bu değişken, 
